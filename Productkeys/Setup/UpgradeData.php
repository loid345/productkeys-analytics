...
class UpgradeData implements UpgradeDataInterface
{
    ...
    public function upgrade(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (version_compare($context->getVersion(), '2.1', '<')) {
            ...
            $eavSetup->addAttribute(
                \Magento\Catalog\Model\Product::ENTITY,
                'productkey_post_to_an_api',
                [
                    'type' => 'int',
                    'backend' => '',
                    'frontend' => '',
                    'label' => 'Post to an API',
                    'input' => 'select',
                    'class' => 'productkey_post_to_an_api',
                    'source' => 'Dart\Productkeys\Model\Config\Source\Options',
                    'backend' => 'Magento\Eav\Model\Entity\Attribute\Backend\ArrayBackend',
                    'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    'visible' => true,
            ...
            $eavSetup->addAttribute(
                ...
                [
                    ...
                    'label' => 'API Method',
                    'input' => 'select',
                    'class' => 'productkey_api_method',
                    'source' => 'Dart\Productkeys\Model\Config\Source\IntegerApiMethod',
                    'backend' => 'Magento\Eav\Model\Entity\Attribute\Backend\ArrayBackend',
                    'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    'visible' => true,
                    'required' => false,
            ...
            $eavSetup->addAttribute(
                ...
                [
                    ...
                    'input' => 'select',
                    'class' => 'productkey_api_auth_type',
                    'source' => 'Dart\Productkeys\Model\Config\Source\IntegerApiAuthType',
                    'backend' => 'Magento\Eav\Model\Entity\Attribute\Backend\ArrayBackend',
                    'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    'visible' => true,
                    'required' => false,
            ...
            $eavSetup->addAttribute(
                \Magento\Catalog\Model\Product::ENTITY,
                'productkey_api_auth_header',
                [
                    'type' => 'varchar',
                    'backend' => '',
                    'frontend' => '',
                    'label' => 'API Authentication Header',
                    'input' => 'textarea',
                    'class' => 'productkey_api_auth_header',
                    'source' => '',
                    'backend' => 'Magento\Eav\Model\Entity\Attribute\Backend\ArrayBackend',
                    'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    'visible' => true,
            ...
            $eavSetup->addAttribute(
                ...
                [
                    ...
                    'input' => 'textarea',
                    'class' => 'productkey_api_request_body',
                    'source' => '',
                    'backend' => 'Magento\Eav\Model\Entity\Attribute\Backend\ArrayBackend',
                    'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    'visible' => true,
            ...
            $eavSetup->addAttribute(
                ...
                [
                    ...
                    'input' => 'select',
                    'class' => 'productkey_api_content_type',
                    'source' => 'Dart\Productkeys\Model\Config\Source\IntegerApiContentTypes',
                    'backend' => 'Magento\Eav\Model\Entity\Attribute\Backend\ArrayBackend',
                    'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    'visible' => true,
                    'required' => false,
