...
class Generatekeys extends Action
{
    ...
    public function __construct(
        Context $context,
        TimezoneInterface $timeZone, // Updated property name and type hint
        ...
        $this->timeZone = $timeZone; // Updated property assignment
    ...
    public function saveOrderToProductkeys($orderIncId, $keypool, $_product = null, $storeId = null)
    {
        ...
        if ($collection > 0) {
            ...
            if (count($available_keys) >= 1) {
                ...
                $available_key->setUpdatedAt($this->timeZone->date()->format('Y-m-d H:i:s'));
                $available_key->save();
