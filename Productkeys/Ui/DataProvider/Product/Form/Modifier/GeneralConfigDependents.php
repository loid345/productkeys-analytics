...
class GeneralConfigDependents extends AbstractModifier
{
    ...
    protected function customizeFieldSub(array $meta)
    {
        ...
        'productkey_warning_template', 'productkey_warning_level', 'productkey_warning_email', 'productkey_post_to_an_api', 'productkey_api_endpoint',
        'productkey_api_method', 'productkey_api_auth_type', 'productkey_api_auth_header', 'productkey_api_request_body', 'productkey_api_content_type' ];
